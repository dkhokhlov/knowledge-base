...
2. Edit `.env.local`:
   ...
   - `WEBUI_SECRET_KEY` was already generated by `make bootstrap` in step 1.
     - It is a random JWT signing key for Open WebUI sessions.
     - It is needed before `make start` (Open WebUI will not boot without it).
